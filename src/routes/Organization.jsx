...
const Organization = () => {
  return (
    <div className='w-full h-screen pl-20  md:pl-36 '>


      <h1 className='text-2xl mb-4'>Organization</h1>
      <div class="grid xl:grid-cols-2 2xl:grid-cols-3 gap-y-4 ">
        <div class="flex flex-col justify-around items-center h-[150px] w-[300px] border border-black">
        ...
        </div>   <div class="flex flex-col justify-around items-center h-[150px] w-[300px] border border-black">
            <FiTarget size={40}/>

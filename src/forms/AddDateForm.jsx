  ...
  return (
    <form>
      <div className="space-y-4">
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                  <input
                    ...
                    placeholder="For example: Date of employment"
                  />
                </div>
              </div>
                </div>
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                <textarea
                  ...
                  defaultValue={''}
                  placeholder='For example: Specify employee start date'
                />
              </div>
            </div>
          </div>
        ...
        {/* segments */}
        {/* sa pikselima uradi */}
        <div className=' w-full flex items-center bg-red-100'>
          <div className=''>
          ...
          <div className='bg-blue-100 w-full flex'>
            <div className='flex bg-green-100 w-2/4 justify-between'>
                <div className='max-w-[50px] bg-purple-100'>
                ...
                <div className='bg-orange-100 w-3/5'>
                <DateDropdown/>
                </div>
            ...
            <div className='bg-yellow-100 w-2/4 flex justify-between'>
            daj
            <div className='bg-orange-100 w-3/5'>
                <DateDropdown/>
                </div>
            ...
            <div className='bg-green-100  justify-between'>
                <Button text={"Add"}/>
            </div>
          </div>
        </div>
